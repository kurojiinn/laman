...
struct OrderView: View {
    ...
    @State private var guestName: String = "Ахмед Хаджиев"
    @State private var guestPhone: String = "+79991234567"
    @State private var guestAddress: String = "Грозный, ул. Айтхазарова 45"
    @State private var deliveryAddress: String = "Грозный, ул. Айтхазарова 45"
    @State private var comment: String = "Звонить за час"
